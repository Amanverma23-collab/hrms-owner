...
export default function EditCompany() {
  ...
  const [form, setForm] = useState<any>({
    ...
    admin_email: '',
    admin_phone: '',
    admin_temp_password: 'Temp@12345',
    plan_id: '',
    employee_limit: 50,
    storage_limit_gb: 10,
    trial_days: 14,
    ...
    <form onSubmit={submit} className="space-y-4">
      <NeumoCard className="p-4">
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            <div className="text-sm font-semibold text-white">Edit Company</div>
      ...
      <Section title="Admin Details">
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-3">
          <Field label="Admin Email">
            <Input value={form.admin_email} onChange={(e) => set('admin_email', e.target.value)} type="email" placeholder="admin@company.com" />
          </Field>
